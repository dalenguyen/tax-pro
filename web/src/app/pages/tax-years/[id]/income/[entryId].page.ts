    ...
    <div class="min-h-screen bg-gray-50 p-6">
      <div class="max-w-2xl mx-auto">
        <div class="flex items-center gap-4 mb-6">
          <a [routerLink]="['/tax-years', taxYearId, 'income']" class="text-gray-500 hover:text-gray-700 text-sm">&larr; Back</a>
...
export default class IncomeEditComponent implements OnInit {
  ...
  async onSubmit() {
    ...
    try {
      ...
      this.router.navigate(['/tax-years', this.taxYearId, 'income']);
    } finally {
