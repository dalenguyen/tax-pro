    ...
    <div class="min-h-screen bg-gray-50 p-6">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <a [routerLink]="['/tax-years', taxYearId, 'reports', 'summary']"
          ...
          <a [routerLink]="['/tax-years', taxYearId, 'reports', 'income-statement']"
             class="bg-white rounded-lg shadow p-6 hover:shadow-md transition block">
            <div class="text-2xl mb-2">&#128176;</div>
          ...
          <a [routerLink]="['/tax-years', taxYearId, 'reports', 'expense-breakdown']"
             class="bg-white rounded-lg shadow p-6 hover:shadow-md transition block">
            <div class="text-2xl mb-2">&#128179;</div>
          ...
          <a [routerLink]="['/tax-years', taxYearId, 'reports', 'rental-statement']"
             class="bg-white rounded-lg shadow p-6 hover:shadow-md transition block">
            <div class="text-2xl mb-2">&#127968;</div>
          ...
          <a [routerLink]="['/tax-years', taxYearId, 'reports', 'investment-summary']"
             class="bg-white rounded-lg shadow p-6 hover:shadow-md transition block">
            <div class="text-2xl mb-2">&#128200;</div>
          ...
          <a [routerLink]="['/tax-years', taxYearId, 'reports', 't2125']"
             class="bg-white rounded-lg shadow p-6 hover:shadow-md transition block">
            <div class="text-2xl mb-2">&#128203;</div>
