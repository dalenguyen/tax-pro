    ...
    <div class="min-h-screen bg-gray-50 p-6">
      <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-4 mb-6">
          <a routerLink="/dashboard/tax-years" class="text-gray-500 hover:text-gray-700 text-sm">&larr; Tax Years</a>
          @if (taxYear()) {
        ...
        @if (loading()) {
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a [routerLink]="['/dashboard/tax-years', taxYearId, 'rental']"
               class="bg-white rounded-lg shadow p-6 hover:shadow-md transition block">
              <div class="text-2xl mb-2">&#127968;</div>
            ...
            <a [routerLink]="['/dashboard/tax-years', taxYearId, 'reports']"
               class="bg-white rounded-lg shadow p-6 hover:shadow-md transition block">
              <div class="text-2xl mb-2">&#128196;</div>
